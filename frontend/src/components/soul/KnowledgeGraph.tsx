...
const HACKATHON_TECHS: Record<string, string[]> = {
  ...
  'AMD Hackathon': ['Python', 'Rust', 'vLLM', 'PyTorch', 'Transformers', 'HuggingFace'],
  'RAISE Summit': ['TypeScript', 'Next.js', 'React', 'Tailwind', 'Vercel'],
  'Dify Paris': ['Python', 'Dify', 'ElevenLabs', 'OpenAI', 'Twilio'],
...
const COMPANY_TECHS: Record<string, string[]> = {
  ...
  'Societe Generale': ['Python', 'LangChain', 'ElasticSearch', 'Streamlit', 'RabbitMQ', 'GitHub Actions', 'Docker'],
