...
export default function SkillsView() {
  ...
  const DEFAULT_NARRATIVE = 'Creative technologist assembling skills across domains. From enterprise RAG pipelines at Societe Generale to multi-agent orchestration at Misogi Labs, from 3D spatial intelligence to music AI at Mozart AI. Tested across 29 hackathons with 14 wins — every domain shift adds a new capability to the stack.'
  ...
  return (
    <div className="editor-page">
      <div className="editor-meta">Agent skill manifest — {skills?.length || 0} domains, 29 missions</div>
      <h1>Skills</h1>
      ...
      <div className="editor-content">
        ...
        <div className="skill-nav-cards">
          <Link to="/files/skill/hackathons" className="skill-nav-card" data-interactive>
            ...
            <div className="skill-nav-card-stat">29 missions · 14 wins</div>
          </Link>
